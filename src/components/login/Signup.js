        ...
        <Wrapper>
            ...
            <Card className="card">
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <FormGroup className="form" label="Password Confirmation" labelFor="text-input" labelInfo="(required)">
                        <InputGroup type="password" id="password-confirm" placeholder="Password" ref={passwordConfRef}  />
                    </FormGroup>
